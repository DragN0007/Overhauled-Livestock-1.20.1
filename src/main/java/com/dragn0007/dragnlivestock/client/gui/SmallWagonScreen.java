...
public class SmallWagonScreen extends AbstractWagonScreen<SmallWagonMenu> {

    public SmallWagonScreen(SmallWagonMenu menu, Inventory inventory, Component title) {
