...
import com.dragn0007.dragnlivestock.common.entities.ai.FrogSitOnBlockGoal;
...
public class OFrog extends Animal implements GeoEntity {
	...
	private static final ResourceLocation LOOT_TABLE = LivestockOverhaul.id("entities/o_frog");
