...
public class MiningCart extends AbstractInventoryWagon {
    ...
    public MiningCart(EntityType<? extends AbstractWagon> type, Level level) {
        super(type, level, 0.12D, 2.0D, 3.0F, 40, 54, ANIMALS, 1.25D, 1.25D, RIDERS);
    }
    ...
    public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
        return new MiningCartMenu(id, inventory, this);
    }

    public ItemStack getPickResult() {
        return LOItems.MINING_CART.get().getDefaultInstance();
    }
