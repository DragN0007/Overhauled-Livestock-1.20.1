...
public class OFrogEyeLayer extends GeoRenderLayer<OFrog> {
    ...
    public enum Overlay {
        NONE(LivestockOverhaul.id("textures/entity/frog/overlay/none.png")),
        BLUE_EYES(LivestockOverhaul.id("textures/entity/frog/overlay/frog_eyes_blue.png")),
        BLACK_EYES(LivestockOverhaul.id("textures/entity/frog/overlay/frog_eyes_black.png")),
        GREEN_EYES(LivestockOverhaul.id("textures/entity/frog/overlay/frog_eyes_green.png")),
        ORANGE_EYES(LivestockOverhaul.id("textures/entity/frog/overlay/frog_eyes_orange.png")),
        RED_EYES(LivestockOverhaul.id("textures/entity/frog/overlay/frog_eyes_red.png")),
        PURPLE_EYES(LivestockOverhaul.id("textures/entity/frog/overlay/frog_eyes_purple.png"));
