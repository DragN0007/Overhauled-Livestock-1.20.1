package com.dragn0007.dragnlivestock.blocks.client.render.entity.moobloom.peach;
...
public class PeachMoobloomRenderer extends GeoEntityRenderer<PeachMoobloom> {

    public PeachMoobloomRenderer(EntityRendererProvider.Context renderManager) {
