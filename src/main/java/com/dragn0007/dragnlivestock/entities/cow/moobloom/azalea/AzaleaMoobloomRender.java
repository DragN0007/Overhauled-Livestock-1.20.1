...
public class AzaleaMoobloomRender extends GeoEntityRenderer<AzaleaMoobloom> {
    ...
    public AzaleaMoobloomRender(EntityRendererProvider.Context renderManager) {
        ...
        this.addRenderLayer(new AzaleaMoobloomBodyLayer(this));
        this.addRenderLayer(new AzaleaMoobloomTackLayer(this));
    }

    @Override
    public void preRender(PoseStack poseStack, AzaleaMoobloom animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
