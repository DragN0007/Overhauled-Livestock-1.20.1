...
public class OFrog extends Animal implements GeoEntity {
	...
	public static final ResourceLocation LOOT_TABLE = new ResourceLocation(LivestockOverhaul.MODID, "entities/o_frog");
	public static final ResourceLocation VANILLA_LOOT_TABLE = new ResourceLocation("minecraft", "entities/frog");
	...
	public ResourceLocation getEyesLocation() {
		return OFrogRenderLayer.EyeColor.overlayFromOrdinal(getEyesVariant()).resourceLocation;
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor serverLevelAccessor, DifficultyInstance instance, MobSpawnType spawnType, @Nullable SpawnGroupData data, @Nullable CompoundTag tag) {
		...
		setEyesVariant(random.nextInt(OFrogRenderLayer.EyeColor.values().length));
