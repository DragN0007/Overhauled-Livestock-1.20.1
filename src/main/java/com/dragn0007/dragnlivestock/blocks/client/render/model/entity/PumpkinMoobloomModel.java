...
public class PumpkinMoobloomModel extends DefaultedEntityGeoModel<PumpkinMoobloom> {
    ...
    public PumpkinMoobloomModel() {
        super(LivestockOverhaul.id("pumpkin_moobloom"), true);
    }
    ...
    public enum Variant {
        DEFAULT(LivestockOverhaul.id("textures/entity/moobloom/pumpkin.png"));
    ...
    public static final ResourceLocation MODEL = LivestockOverhaul.id("geo/moobloom/crop_moobloom.geo.json");
