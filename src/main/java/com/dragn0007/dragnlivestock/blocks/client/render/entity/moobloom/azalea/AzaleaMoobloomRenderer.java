package com.dragn0007.dragnlivestock.blocks.client.render.entity.moobloom.azalea;
...
public class AzaleaMoobloomRenderer extends GeoEntityRenderer<AzaleaMoobloom> {

    public AzaleaMoobloomRenderer(EntityRendererProvider.Context renderManager) {
    ...
    @Override
    public void preRender(PoseStack poseStack, AzaleaMoobloom entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
