package com.dragn0007.dragnlivestock.blocks.client.render.entity.moobloom.melon;
...
public class MelonMoobloomRenderer extends GeoEntityRenderer<MelonMoobloom> {

    public MelonMoobloomRenderer(EntityRendererProvider.Context renderManager) {
