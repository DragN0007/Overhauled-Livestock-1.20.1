...
public class CarrotMoobloomRender extends GeoEntityRenderer<CarrotMoobloom> {
    ...
    public CarrotMoobloomRender(EntityRendererProvider.Context renderManager) {
        ...
        this.addRenderLayer(new CarrotMoobloomBodyLayer(this));
        this.addRenderLayer(new CarrotMoobloomTackLayer(this));
    }

    @Override
    public void preRender(PoseStack poseStack, CarrotMoobloom animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
