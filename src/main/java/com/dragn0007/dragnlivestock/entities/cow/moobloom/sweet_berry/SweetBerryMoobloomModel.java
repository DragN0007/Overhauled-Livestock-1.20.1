...
public class SweetBerryMoobloomModel extends GeoModel<SweetBerryMoobloom> {

    public enum Variant {
        DEFAULT(new ResourceLocation(LivestockOverhaul.MODID, "textures/entity/moobloom/moobloom_sweet_berry.png"));
