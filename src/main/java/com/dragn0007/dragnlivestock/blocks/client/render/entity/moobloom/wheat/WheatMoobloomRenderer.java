package com.dragn0007.dragnlivestock.blocks.client.render.entity.moobloom.wheat;
...
public class WheatMoobloomRenderer extends GeoEntityRenderer<WheatMoobloom> {

    public WheatMoobloomRenderer(EntityRendererProvider.Context renderManager) {
