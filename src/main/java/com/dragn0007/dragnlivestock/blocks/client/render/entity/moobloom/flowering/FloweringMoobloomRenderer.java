package com.dragn0007.dragnlivestock.blocks.client.render.entity.moobloom.flowering;
...
public class FloweringMoobloomRenderer extends GeoEntityRenderer<FloweringMoobloom> {

    public FloweringMoobloomRenderer(EntityRendererProvider.Context renderManager) {
    ...
    @Override
    public void preRender(PoseStack poseStack, FloweringMoobloom entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
