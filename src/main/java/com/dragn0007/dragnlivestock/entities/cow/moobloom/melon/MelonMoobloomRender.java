...
public class MelonMoobloomRender extends GeoEntityRenderer<MelonMoobloom> {
    ...
    public MelonMoobloomRender(EntityRendererProvider.Context renderManager) {
        ...
        this.addRenderLayer(new MelonMoobloomBodyLayer(this));
        this.addRenderLayer(new MelonMoobloomTackLayer(this));
    }

    @Override
    public void preRender(PoseStack poseStack, MelonMoobloom animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
