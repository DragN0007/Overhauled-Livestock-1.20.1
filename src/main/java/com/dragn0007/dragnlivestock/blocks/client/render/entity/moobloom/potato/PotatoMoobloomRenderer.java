package com.dragn0007.dragnlivestock.blocks.client.render.entity.moobloom.potato;
...
public class PotatoMoobloomRenderer extends GeoEntityRenderer<PotatoMoobloom> {

    public PotatoMoobloomRenderer(EntityRendererProvider.Context renderManager) {
