...
import com.dragn0007.dragnlivestock.common.entities.mule.*;
...
public class OMuleRenderer extends GeoEntityRenderer<OMule> {

    public OMuleRenderer(EntityRendererProvider.Context renderManager) {
