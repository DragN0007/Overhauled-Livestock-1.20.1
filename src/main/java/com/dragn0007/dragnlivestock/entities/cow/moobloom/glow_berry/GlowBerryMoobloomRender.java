...
public class GlowBerryMoobloomRender extends GeoEntityRenderer<GlowBerryMoobloom> {
    ...
    public GlowBerryMoobloomRender(EntityRendererProvider.Context renderManager) {
        ...
        this.addRenderLayer(new GlowBerryMoobloomBodyLayer(this));
        this.addRenderLayer(new GlowBerryMoobloomTackLayer(this));
    }

    @Override
    public void preRender(PoseStack poseStack, GlowBerryMoobloom animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
