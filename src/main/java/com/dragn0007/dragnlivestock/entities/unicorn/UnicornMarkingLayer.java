...
public class UnicornMarkingLayer extends GeoRenderLayer<Unicorn> {
    ...
    public enum Overlay {
        NONE(new ResourceLocation(LivestockOverhaul.MODID, "textures/entity/unicorn/overlay/none.png")),
        ...
        REVERSED_HALF_SOCKS(new ResourceLocation(LivestockOverhaul.MODID, "textures/entity/unicorn/overlay/reversed_half_socks.png")),
        REVERSED_FULL_SOCKS(new ResourceLocation(LivestockOverhaul.MODID, "textures/entity/unicorn/overlay/reversed_full_socks.png")),
