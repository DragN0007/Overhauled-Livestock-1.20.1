...
public class OGoatCarpetLayer extends GeoRenderLayer<OGoat> {
    public static final ResourceLocation[] TEXTURE_LOCATION = new ResourceLocation[]{
            ...
            new ResourceLocation(LivestockOverhaul.MODID, "textures/entity/goat/carpet/gray.png"),
            new ResourceLocation(LivestockOverhaul.MODID, "textures/entity/goat/carpet/light_gray.png"),
