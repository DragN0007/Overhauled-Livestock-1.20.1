...
public class OSheepWoolLayer extends GeoRenderLayer<OSheep> {
    ...
    public enum Overlay {
        BLACK(LivestockOverhaul.id("textures/entity/sheep/wool/black.png")),
        BROWN(LivestockOverhaul.id("textures/entity/sheep/wool/brown.png")),
        GREY(LivestockOverhaul.id("textures/entity/sheep/wool/grey.png")),
        LIGHT_GREY(LivestockOverhaul.id("textures/entity/sheep/wool/light_grey.png")),
        TAN(LivestockOverhaul.id("textures/entity/sheep/wool/tan.png")),
        WHITE(LivestockOverhaul.id("textures/entity/sheep/wool/white.png")),
