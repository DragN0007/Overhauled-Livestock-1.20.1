...
public class LivestockWagonScreen extends AbstractWagonScreen<LivestockWagonMenu> {

    public LivestockWagonScreen(LivestockWagonMenu menu, Inventory inventory, Component title) {
