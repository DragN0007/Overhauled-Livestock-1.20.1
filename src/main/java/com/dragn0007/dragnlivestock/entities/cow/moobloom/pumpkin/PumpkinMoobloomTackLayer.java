...
@OnlyIn(Dist.CLIENT)
public class PumpkinMoobloomTackLayer extends GeoRenderLayer<PumpkinMoobloom> {
    public PumpkinMoobloomTackLayer(GeoRenderer<PumpkinMoobloom> entityRendererIn) {
