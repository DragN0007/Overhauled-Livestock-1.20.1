...
@OnlyIn(Dist.CLIENT)
public class GlowBerryMoobloomTackLayer extends GeoRenderLayer<GlowBerryMoobloom> {
    public GlowBerryMoobloomTackLayer(GeoRenderer<GlowBerryMoobloom> entityRendererIn) {
