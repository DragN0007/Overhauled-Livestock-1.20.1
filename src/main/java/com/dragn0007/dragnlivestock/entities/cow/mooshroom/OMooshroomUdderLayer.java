...
public class OMooshroomUdderLayer extends GeoRenderLayer<OMooshroom> {
    public OMooshroomUdderLayer(GeoRenderer entityRendererIn) {
    ...
    public void render(PoseStack poseStack, OMooshroom animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
        RenderType renderMarkingType = RenderType.entityCutout(((OMooshroom)animatable).getUddersLocation());
        poseStack.pushPose();
