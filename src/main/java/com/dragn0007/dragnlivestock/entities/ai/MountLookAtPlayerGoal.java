...
public class MountLookAtPlayerGoal extends Goal {
   ...
   public MountLookAtPlayerGoal(AbstractOMount p_25520_, Class<? extends LivingEntity> p_25521_, float p_25522_) {
      this(p_25520_, p_25521_, p_25522_, 0.02F);
   }

   public MountLookAtPlayerGoal(AbstractOMount p_25524_, Class<? extends LivingEntity> p_25525_, float p_25526_, float p_25527_) {
      this(p_25524_, p_25525_, p_25526_, p_25527_, false);
   }

   public MountLookAtPlayerGoal(AbstractOMount p_148118_, Class<? extends LivingEntity> p_148119_, float p_148120_, float p_148121_, boolean p_148122_) {
      this.mob = p_148118_;
