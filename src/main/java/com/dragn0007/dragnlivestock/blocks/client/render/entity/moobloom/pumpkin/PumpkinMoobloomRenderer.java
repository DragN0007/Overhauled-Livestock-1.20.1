package com.dragn0007.dragnlivestock.blocks.client.render.entity.moobloom.pumpkin;
...
public class PumpkinMoobloomRenderer extends GeoEntityRenderer<PumpkinMoobloom> {

    public PumpkinMoobloomRenderer(EntityRendererProvider.Context renderManager) {
