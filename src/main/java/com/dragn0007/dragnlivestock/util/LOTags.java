...
public class LOTags {
    ...
    public static class Items {
        ...
        public static final TagKey<Item> CRAFTING_METALS = tag("crafting_metals");
        public static final TagKey<Item> CRAFTING_METAL_NUGGETS = tag("crafting_metal_nuggets");
        public static final TagKey<Item> GOLD_METALS = tag("gold_metals");
        public static final TagKey<Item> GOLD_METAL_NUGGETS = tag("gold_metal_nuggets");
    ...
    public static class Blocks {
        public static final TagKey<Block> GRASS_BLOCKS = forgeTag("grass_blocks");
