...
public class OverworldUnicorn extends OHorse implements GeoEntity {
	...
	private static final ResourceLocation LOOT_TABLE = new ResourceLocation(LivestockOverhaul.MODID, "entities/overworld_unicorn");
