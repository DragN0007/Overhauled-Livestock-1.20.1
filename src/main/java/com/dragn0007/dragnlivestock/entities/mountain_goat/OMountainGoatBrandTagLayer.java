...
@OnlyIn(Dist.CLIENT)
public class OMountainGoatBrandTagLayer extends GeoRenderLayer<OMountainGoat> {
    ...
    public OMountainGoatBrandTagLayer(GeoRenderer<OMountainGoat> entityRendererIn) {
