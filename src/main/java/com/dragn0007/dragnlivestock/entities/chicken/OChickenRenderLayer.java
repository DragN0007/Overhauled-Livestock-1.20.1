...
public class OChickenRenderLayer extends GeoRenderLayer<OChicken> {
    public OChickenRenderLayer(GeoRenderer entityRendererIn) {
    ...
    public void render(PoseStack poseStack, OChicken animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
        ...
        if (animatable.isTagged()) {
            ...
            if (dyeColor != null) {
                resourceLocation = new ResourceLocation(LivestockOverhaul.MODID, "textures/entity/tag/chicken/" + dyeColor + ".png");
            }
