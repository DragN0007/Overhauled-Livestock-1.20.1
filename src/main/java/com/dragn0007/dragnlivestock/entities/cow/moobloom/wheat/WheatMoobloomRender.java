...
public class WheatMoobloomRender extends GeoEntityRenderer<WheatMoobloom> {
    ...
    public WheatMoobloomRender(EntityRendererProvider.Context renderManager) {
        ...
        this.addRenderLayer(new WheatMoobloomBodyLayer(this));
        this.addRenderLayer(new WheatMoobloomTackLayer(this));
    }

    @Override
    public void preRender(PoseStack poseStack, WheatMoobloom animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
