...
@OnlyIn(Dist.CLIENT)
public class SweetBerryMoobloomTackLayer extends GeoRenderLayer<SweetBerryMoobloom> {
    public SweetBerryMoobloomTackLayer(GeoRenderer<SweetBerryMoobloom> entityRendererIn) {
