...
import com.dragn0007.dragnlivestock.common.menus.OMountMenu;
...
public class OMountScreen extends AbstractContainerScreen<OMountMenu> {
    ...
    public static final ResourceLocation MOUNT_INVENTORY_LOCATION = LivestockOverhaul.id("textures/gui/o_mount.png");
