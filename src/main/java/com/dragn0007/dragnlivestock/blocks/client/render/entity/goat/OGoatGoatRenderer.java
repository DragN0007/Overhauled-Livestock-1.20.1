package com.dragn0007.dragnlivestock.blocks.client.render.entity.goat;
...
public class OGoatGoatRenderer extends GeoEntityRenderer<OGoat> {

    public OGoatGoatRenderer(EntityRendererProvider.Context renderManager) {
