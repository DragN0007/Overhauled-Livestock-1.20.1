...
public class OFrogMarkingLayer extends GeoRenderLayer<OFrog> {
    ...
    public enum Overlay {
        ...
        BLUE_LEGS(LivestockOverhaul.id("textures/entity/frog/overlay/frog_blue_legs.png")),
        DART(LivestockOverhaul.id("textures/entity/frog/overlay/frog_dart.png")),
        DART_PURPLE(LivestockOverhaul.id("textures/entity/frog/overlay/frog_dart_purple.png")),
        DART_YELLOW(LivestockOverhaul.id("textures/entity/frog/overlay/frog_dart_yellow.png")),
        STRIPED(LivestockOverhaul.id("textures/entity/frog/overlay/frog_striped.png"));
