...
public class OCowHarnessLayer extends GeoRenderLayer<OCow> {
    ...
    public void render(PoseStack poseStack, OCow animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
        ...
        if (animatable.isHarnessed()) {
            resourceLocation = LivestockOverhaul.id("textures/entity/cow/tack/rodeo_harness.png");
        ...
        if (animatable.isBelled()) {
            resourceLocation = LivestockOverhaul.id("textures/entity/cow/tack/bell.png");
        ...
        if (animatable.isSaddled()) {
            resourceLocation = LivestockOverhaul.id("textures/entity/cow/tack/wagon_harness.png");
        ...
        if (animatable.hasChest()) {
            resourceLocation = LivestockOverhaul.id("textures/entity/cow/tack/saddlebags.png");
