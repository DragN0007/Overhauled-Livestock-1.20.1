...
public class PumpkinMoobloomRender extends GeoEntityRenderer<PumpkinMoobloom> {
    ...
    public PumpkinMoobloomRender(EntityRendererProvider.Context renderManager) {
        ...
        this.addRenderLayer(new PumpkinMoobloomBodyLayer(this));
        this.addRenderLayer(new PumpkinMoobloomTackLayer(this));
    }

    @Override
    public void preRender(PoseStack poseStack, PumpkinMoobloom animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
