...
@OnlyIn(Dist.CLIENT)
public class BeetrootMoobloomTackLayer extends GeoRenderLayer<BeetrootMoobloom> {
    public BeetrootMoobloomTackLayer(GeoRenderer<BeetrootMoobloom> entityRendererIn) {
