...
public class GlowBerryMoobloomModel extends DefaultedEntityGeoModel<GlowBerryMoobloom> {
    ...
    public GlowBerryMoobloomModel() {
        super(new ResourceLocation(LivestockOverhaul.MODID, "glow_berry_moobloom"), true);
    }
    ...
    public enum Variant {
        DEFAULT(new ResourceLocation(LivestockOverhaul.MODID, "textures/entity/moobloom/glow_berry.png"));
