...
public class PeachMoobloomRender extends GeoEntityRenderer<PeachMoobloom> {
    ...
    public PeachMoobloomRender(EntityRendererProvider.Context renderManager) {
        ...
        this.addRenderLayer(new PeachMoobloomBodyLayer(this));
        this.addRenderLayer(new PeachMoobloomTackLayer(this));
    }

    @Override
    public void preRender(PoseStack poseStack, PeachMoobloom animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
