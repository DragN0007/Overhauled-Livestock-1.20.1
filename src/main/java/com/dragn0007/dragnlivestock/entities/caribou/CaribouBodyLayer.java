...
public class CaribouBodyLayer extends GeoRenderLayer<Caribou> {
    public CaribouBodyLayer(GeoRenderer entityRendererIn) {
        super(entityRendererIn);
    }

    public static final Map<String, ResourceLocation> TEXTURE_CACHE = new HashMap<>();
    public ResourceLocation getTexture(Caribou animatable) {
