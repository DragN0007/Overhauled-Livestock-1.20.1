...
import com.dragn0007.dragnlivestock.common.entities.horse.*;
...
public class OHorseRenderer extends GeoEntityRenderer<OHorse> {

    public OHorseRenderer(EntityRendererProvider.Context renderManager) {
