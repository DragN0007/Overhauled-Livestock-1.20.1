package com.dragn0007.dragnlivestock.blocks.client.render.entity.caribou;
...
public class CaribouRenderer extends GeoEntityRenderer<Caribou> {

    public CaribouRenderer(EntityRendererProvider.Context renderManager) {
