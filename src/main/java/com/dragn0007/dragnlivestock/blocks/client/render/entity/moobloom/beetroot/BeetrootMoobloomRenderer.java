...
public class BeetrootMoobloomRenderer extends GeoEntityRenderer<BeetrootMoobloom> {

    public BeetrootMoobloomRenderer(EntityRendererProvider.Context renderManager) {
