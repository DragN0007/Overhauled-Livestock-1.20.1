...
@OnlyIn(Dist.CLIENT)
public class FloweringMoobloomTackLayer extends GeoRenderLayer<FloweringMoobloom> {
    public FloweringMoobloomTackLayer(GeoRenderer<FloweringMoobloom> entityRendererIn) {
