...
public class SweetBerryMoobloomRender extends GeoEntityRenderer<SweetBerryMoobloom> {
    ...
    public SweetBerryMoobloomRender(EntityRendererProvider.Context renderManager) {
        ...
        this.addRenderLayer(new SweetBerryMoobloomBodyLayer(this));
        this.addRenderLayer(new SweetBerryMoobloomTackLayer(this));
    }

    @Override
    public void preRender(PoseStack poseStack, SweetBerryMoobloom animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
